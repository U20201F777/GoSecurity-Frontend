...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [{ path: 'nuevo', component: TipoCasoInsertarComponent }],
  },
  {
    path: 'ciudadano',
  ...
  },
  {
    ...
    children: [
      {
        path: 'insertar',
        component: InsertarComisariaComponent,
      },
    ],
  },
  {
    ...
    children: [
      {
        path: 'insertar',
        component: InsertarDenunciasComponent,
      },
    ],
  },
  {
    ...
    children: [
      {
        path: 'insertar',
        component: InsertarUbicacioncComponent,
      },
    ],
  },
];
